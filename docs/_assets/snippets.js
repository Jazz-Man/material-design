 ...
 * @private
 */
MaterialComponentsSnippets.prototype.cssClasses = {
  COPIED: 'copied',
...
MaterialComponentsSnippets.prototype.onMouseClickHandler = function(snippet) {
  ...
  return function() {
    ...
    var cls = this.cssClasses.COPIED;
    if (!this.copyToClipboard(snippet)) {
      cls = this.cssClasses.NOT_SUPPORTED;
    }
...
MaterialComponentsSnippets.prototype.onMouseOutHandler = function(snippet) {
  ...
  return function() {
    snippet.classList.remove(this.cssClasses.COPIED);
  }.bind(this);
};
