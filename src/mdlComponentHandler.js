  ...
  function() {
    ...
    function deconstructComponentInternal(component) {
      if (component) {
        ...
        var upgrades = component.element.getAttribute('data-upgraded').split(',');
        var componentPlace = upgrades.indexOf(component[componentConfigProperty_].classAsString);
        upgrades.splice(componentPlace, 1);
        component.element.setAttribute('data-upgraded', upgrades.join(','));
        ...
        component.element.dispatchEvent(ev);
      }
    }
