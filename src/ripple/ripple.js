...
(function() {
   ...
   * @private
   */
  MaterialRipple.prototype.Constant = {
   ...
   * @private
   */
  MaterialRipple.prototype.cssClasses = {
  ...
  MaterialRipple.prototype.init = function() {
    if (this.element) {
      var recentering =
          this.element.classList.contains(this.cssClasses.RIPPLE_CENTER);
      if (!this.element.classList.contains(
          this.cssClasses.RIPPLE_EFFECT_IGNORE_EVENTS)) {
        this.rippleElement = this.element.querySelector('.' +
                                                        this.cssClasses.RIPPLE);
        this.frameCount_ = 0;
        this.rippleSize_ = 0;
        this.x_ = 0;
        this.y_ = 0;
